...
public:
     ...
     */
    [[nodiscard]] std::map<Element, std::vector<size_t>> GetElementOfAtomIdVectorMap() const;
     ...
     */
    [[nodiscard]] Eigen::RowVector3d GetLatticePairCenter(const std::pair<size_t, size_t> &lattice_id_jump_pair) const;
